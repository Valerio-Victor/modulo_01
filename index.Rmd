...
```{r figura1, echo=FALSE, message=FALSE, warning=FALSE, out.width="200%", fig.align='center', fig.cap="Participação das energias renováveis na oferta interna de energia brasileira. [1], [2]"}
...
```{r figura33, echo=FALSE, message=FALSE, warning=FALSE, out.width="80%", fig.align='center', fig.cap="Produção de e-fuels a partir da produção de H2 renovável. [44]"}
